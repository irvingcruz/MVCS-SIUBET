$(document).ready(function () {
    ...
    gridTransferencias = $("#gridTransferencias").dxDataGrid({
        columns: [
            ...
            { dataField: "Responsable", caption: "Destino", alignment: "center", width: 200, },
                        ...
                        items: [
                            {
                                ...
                                options: {
                                    ...
                                    text: "Editar",
                                    onClick: function () {
                                        fnOpenPopupTransferenciaEdit(item.IDMovimiento);
                                    }
                                }
    ...
    function fnOpenPopupTransferenciaEdit(IDMovimiento) {
        popupTransferenciaEdit = $("#popup-transferencia-edit").dxPopup({
            showTitle: true,
            ...
            contentTemplate: function () {
                ...
                return $pageContent.load($urlReal + 'Movimiento/TEditar/' + IDMovimiento);
            },
            showCloseButton: true,
        });
        popupTransferenciaEdit.dxPopup("instance").show();
    }
